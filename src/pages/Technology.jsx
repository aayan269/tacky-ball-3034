...
const COLUMN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=book&pageSize=3&page=1&apiKey=737de212e6c549f8a39ce376180cc4e1`).then((res)=>{
       // console.log(res.data.articles)
...
const EDUCATION=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=science&pageSize=4&page=1&apiKey=737de212e6c549f8a39ce376180cc4e1`).then((res)=>{
       // console.log(res.data.articles)
...
const FOOTBALL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=football&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const CRICKET=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=cricket&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const TECHNOLOGY=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=technology&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const WORLD=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=korea&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const JAPAN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=japan&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
