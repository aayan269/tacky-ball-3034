...
const POPULAR=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=10&page=3&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
...
const COMMON=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=15&page=2&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
        //console.log(res.data.articles)
...
const NATIONAL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=3&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const COLUMN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=train&pageSize=3&page=2&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&q=car&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH2=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=car&pageSize=4&page=1&apiKey=8359beadc27c4e8091b546a0242a84b6`).then((res)=>{
       // console.log(res.data.articles)
...
const EDUCATION=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&q=ev&pageSize=4&page=1&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const FOOTBALL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=4&page=12&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const CRICKET=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=4&page=13&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const TECHNOLOGY=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=4&page=14&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const WORLD=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=china&category=business&pageSize=4&page=1&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const JAPAN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=china&category=business&pageSize=4&page=2&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
JAPAN(dispatch)
   ...
   // console.log(state)
    ...
    return (
       ...
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>CAR</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            ...
            <div style={{width:"80%",margin:"auto"}}><hr/></div>
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>GLOBAL</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
          ...
          <div style={{width:"80%",margin:"auto"}}><hr/></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>INNOVATIVE</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
