...
const POPULAR=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=science&pageSize=10&page=4&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
...
const COMMON=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=science&pageSize=15&page=2&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
        //console.log(res.data.articles)
...
const NATIONAL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=science&pageSize=3&page=1&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const COLUMN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&q=movie&pageSize=3&page=1&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=space&category=science&pageSize=4&page=2&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH2=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=space&category=science&pageSize=4&page=4&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const EDUCATION=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=earth&category=science&pageSize=4&page=4&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const FOOTBALL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=hubble&category=science&pageSize=4&page=3&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const CRICKET=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=hubble&category=science&pageSize=4&page=1&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const TECHNOLOGY=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=light&category=science&pageSize=4&page=2&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const WORLD=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=moon&category=science&pageSize=4&page=1&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
const JAPAN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=moon&category=science&pageSize=4&page=4&apiKey=e3309366d23c4f4aa09368867e6aadae`).then((res)=>{
       // console.log(res.data.articles)
...
JAPAN(dispatch)
   ...
   // console.log(state)
    ...
    return (
       ...
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>SPACE</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            ...
            <div style={{width:"80%",margin:"auto"}}><hr/></div>
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>EARTH</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
          ...
          <div style={{width:"80%",margin:"auto"}}><hr/></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>HUBBLE TELESCOPE</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>TECHNOLOGY</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>MOON</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
