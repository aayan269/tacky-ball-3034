...
const POPULAR=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=sports&pageSize=10&page=4&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
...
const COMMON=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=sports&pageSize=15&page=2&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
        //console.log(res.data.articles)
...
const NATIONAL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=sports&pageSize=3&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const COLUMN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&q=air&pageSize=3&page=1&apiKey=b18cf464d4654caba30e650a545b534fs`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=football&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH2=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=football&category=sports&pageSize=4&page=2&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const EDUCATION=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=hockey&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const FOOTBALL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=chess&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const CRICKET=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=race&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const TECHNOLOGY=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=cricket&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const WORLD=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=tennis&category=sports&pageSize=4&page=1&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
const JAPAN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=tennis&category=sports&pageSize=4&page=2&apiKey=b18cf464d4654caba30e650a545b534f`).then((res)=>{
       // console.log(res.data.articles)
...
JAPAN(dispatch)
   ...
   // console.log(state)
    ...
    return (
       ...
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>FOOTBALL</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            ...
            <div style={{width:"80%",margin:"auto"}}><hr/></div>
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>HOCKEY</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
          ...
          <div style={{width:"80%",margin:"auto"}}><hr/></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>SPORTS</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>CRCIKET</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>TENNIS</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
