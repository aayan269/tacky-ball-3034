...
const POPULAR=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=entertainment&pageSize=10&page=4&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
...
const COMMON=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=entertainment&pageSize=15&page=2&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
        //console.log(res.data.articles)
...
const NATIONAL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=entertainment&pageSize=3&page=1&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const COLUMN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=ch&category=entertainment&pageSize=3&page=4&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=4&page=7&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const SOUTH2=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=4&page=14&apiKey=01db095110e84f2c897e3fb0745c8dcc`).then((res)=>{
       // console.log(res.data.articles)
...
const EDUCATION=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=music&category=entertainment&pageSize=4&page=1&apiKey=54f9f81080f74692bbc365b46282a66f`).then((res)=>{
       // console.log(res.data.articles)
...
const FOOTBALL=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=dance&category=entertainment&pageSize=4&page=1&apiKey=54f9f81080f74692bbc365b46282a66f`).then((res)=>{
       // console.log(res.data.articles)
...
const CRICKET=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?q=comedy&category=entertainment&pageSize=4&page=1&apiKey=54f9f81080f74692bbc365b46282a66f`).then((res)=>{
       // console.log(res.data.articles)
...
const WORLD=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=4&page=9&apiKey=54f9f81080f74692bbc365b46282a66f`).then((res)=>{
       // console.log(res.data.articles)
...
const JAPAN=(dispatch)=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&pageSize=4&page=8&apiKey=54f9f81080f74692bbc365b46282a66f`).then((res)=>{
       // console.log(res.data.articles)
...
JAPAN(dispatch)
   ...
   // console.log(state)
    ...
    return (
       ...
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>HOLLYWOOD</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            ...
            <div style={{width:"80%",margin:"auto"}}><hr/></div>
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>MUSIC</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
          ...
          <div style={{width:"80%",margin:"auto"}}><hr/></div>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>DANCE</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
            ...
            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>COMEDY</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>

            <div style={{width:"80%",height:"350px",margin:"auto",display:"flex",justifyContent:"space-around"}}>{state.technologyData?.map((el)=>(<TechnologyBox content={el.content}  key={el.description } description={el.description} title={el.title } image={el.urlToImage }/>))}</div>
            <div style={{width:"80%",margin:"auto"}}><hr/></div>


            <div style={{width:"80%",margin:"auto"}}>
       <div style={{display:"flex",flexDirection:"column"}}><h2 style={{textAlign:"start"}}>WORLD</h2>
       <div style={{width:"190px",height:"3px",backgroundColor:"red"}}></div>
            </div></div>
            <div style={{width:"80%",height:"350px",margin:"auto",marginTop:"15px"}}>
